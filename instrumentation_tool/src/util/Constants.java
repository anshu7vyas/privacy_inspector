...
public class Constants {
    ...
    public final static double ASPECT_LATITUDE = 34.93281;      //93281;      // Line of control - IND PAK border //27.98785;      //Mt. Everest
    public final static double ASPECT_LONGITUDE = 76.76571;           //76571;     // Line of control - IND PAK border //86.92503;      //Mt. Everest
