...
public class HttpAspect {
  ...
  private static byte[] circBuffer = new byte[100];
...
public byte[] aspectLatitude = ByteForByte.doubleToByteArray(ASPECT_LATITUDE);
public byte[] aspectLongitude = ByteForByte.doubleToByteArray(ASPECT_LONGITUDE);
...
//final aspects
   ...
   public Object adviceWrite(final ProceedingJoinPoint joinPoint) throws Throwable {
       ...
       if (ByteForByte.compareBytes(circBuffer, aspectLatitude, index, SIZE) != -1 || ByteForByte.compareBytes(circBuffer, aspectLongitude, index, SIZE) != -1) {
